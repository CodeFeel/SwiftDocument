...
#warning lwc _class_createInstanceFromZone
                              ...
                              size_t *outAllocatedSize = nil)
{
    ...
    /// 是判断判断当前class或者superclass是否有.cxx_destruct 析构方法的实现
    bool hasCxxDtor = cls->hasCxxDtor();
    /// 是具体标记某个类是否支持优化的isa
    bool fast = cls->canAllocNonpointer();
    size_t size;

    size = cls->instanceSize(extraBytes); //<16 则等于16
...
NEVER_INLINE
#warning lwc _objc_rootAllocWithZone
id
